...
<ol class="breadcrumb border-0 m-0">
    ...
    <li class="breadcrumb-item"><a href="{{ route('purchase-returns.index') }}">{{__('public.PurchaseReturns')}}</a></li>
                ...
                <div class="card-body">
                    ...
                    <form id="purchase-return-form" action="{{ route('purchase-returns.store') }}" method="POST">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label for="paid_amount">{{__('public.AmountReceived')}} <span class="text-danger">*</span></label>
                        ...
                        <div class="mt-3">
                            <button type="submit" class="btn btn-primary">
                                {{__('public.CreatePurchaseReturn')}} <i class="bi bi-check"></i>
                            </button>
                        </div>
                    </form>
                </div>
    ...
    $(document).ready(function() {
        ...
        $('#getTotalAmount').click(function() {
            $('#paid_amount').maskMoney('mask', {
                {
                    Cart::instance('purchase_return') - > total()
                }
            });
        });
