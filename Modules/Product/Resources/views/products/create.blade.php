        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="form-group">
                    <button class="btn btn-primary">{{__('public.CreateProduct')}} <i class="bi bi-check"></i></button>
                </div>
            </div>
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <div class="form-row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="product_name">{{__('public.ProductName')}} <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" name="product_name" required value="{{ old('product_name') }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="product_code">{{__('public.Code')}} <span class="text-danger">*</span></label>
                        ...
                        <div class="form-row">
                            <div class="col-md-6">
                                <label for="category_id">{{__('public.Category')}} <span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="barcode_symbology">{{__('public.BarcodeSymbology')}} <span class="text-danger">*</span></label>
                        ...
                        <div class="form-row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="product_cost">{{__('public.Cost')}} <span class="text-danger">*</span></label>
                                    <input id="product_cost" type="text" class="form-control" name="product_cost" required value="{{ old('product_cost') }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="product_price">{{__('public.Price')}} <span class="text-danger">*</span></label>
                        ...
                        <div class="form-row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="product_quantity">{{__('public.Quantity')}} <span class="text-danger">*</span></label>
                                    <input type="number" class="form-control" name="product_quantity" required value="{{ old('product_quantity') }}" min="1">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="product_stock_alert">{{__('public.AlertQuantity')}} <span class="text-danger">*</span></label>
                        ...
                        <div class="form-row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="product_order_tax">{{__('public.Tax')}} (%)</label>
                                    <input type="number" class="form-control" name="product_order_tax" value="{{ old('product_order_tax') }}" min="1">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="product_tax_type">{{__('public.Taxtype')}}</label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="product_unit">{{__('public.Units')}} <i class="bi bi-question-circle-fill text-info" data-toggle="tooltip" data-placement="top" title="This short text will be placed after Product Quantity."></i> <span class="text-danger">*</span></label>
                        ...
                        <div class="form-group">
                            <label for="product_note">{{__('public.Note')}}</label>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <div class="form-group">
                            <label for="image">{{__('public.ProductImages')}} <i class="bi bi-question-circle-fill text-info" data-toggle="tooltip" data-placement="top" title="Max Files: 3, Max File Size: 1MB, Image Size: 400x400"></i></label>
