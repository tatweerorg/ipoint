...
<ol class="breadcrumb border-0 m-0">
    ...
    <li class="breadcrumb-item active">{{__('public.Settings')}}</li>
</ol>
@endsection
        ...
        <div class="col-lg-12">
            ...
            <div class="card">
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0">{{__('public.GeneralSettings')}}</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('settings.update') }}" method="POST">
                        ...
                        <div class="form-row">
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label for="company_name">{{__('public.CompanyName')}} <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" name="company_name" value="{{ $settings->company_name }}" required>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label for="company_email">{{__('public.CompanyEmail')}} <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" name="company_email" value="{{ $settings->company_email }}" required>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label for="company_phone">{{__('public.CompanyPhone')}} <span class="text-danger">*</span></label>
                        ...
                        <div class="form-row">
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label for="default_currency_id">{{__('public.DefaultCurrency')}} <span class="text-danger">*</span></label>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label for="default_currency_position">{{__('public.DefaultCurrencyPosition')}} <span class="text-danger">*</span></label>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label for="notification_email">{{__('public.NotificationEmail')}} <span class="text-danger">*</span></label>
                        ...
                        <div class="form-row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label for="company_address">{{__('public.CompanyAddress')}} <span class="text-danger">*</span></label>
                        ...
                        <div class="form-group mb-0">
                            <button type="submit" class="btn btn-primary"><i class="bi bi-check"></i> {{__('public.SaveChanges')}}</button>
                        </div>
                    </form>
                </div>
            </div>
