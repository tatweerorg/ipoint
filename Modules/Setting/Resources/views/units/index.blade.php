...
<ol class="breadcrumb border-0 m-0">
    ...
    <li class="breadcrumb-item active">{{__('public.Units')}}</li>
</ol>
@endsection
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    <a href="{{ route('units.create') }}" class="btn btn-primary">
                        {{__('public.AddUnit')}} <i class="bi bi-plus"></i>
                    </a>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered mb-0 text-center" id="data-table">
                            <thead>
                                <tr>
                                    <th class="align-middle">{{__('public.No')}}.</th>
                                    <th class="align-middle">{{__('public.Name')}}</th>
                                    <th class="align-middle">{{__('public.ShortName')}}</th>
                                    <th class="align-middle">{{__('public.Operator')}}</th>
                                    <th class="align-middle">{{__('public.OperationValue')}}</th>
