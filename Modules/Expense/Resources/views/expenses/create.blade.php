        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="form-group">
                    <button class="btn btn-primary">{{__('public.CreateExpense')}} <i class="bi bi-check"></i></button>
                </div>
            </div>
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="amount">{{__('public.Amount')}} <span class="text-danger">*</span></label>
                        ...
                        <div class="form-group">
                            <label for="details">{{__('public.Details')}}</label>
