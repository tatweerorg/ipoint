...
<ol class="breadcrumb border-0 m-0">
    ...
    <li class="breadcrumb-item"><a href="{{ route('quotations.index') }}">{{__('public.Quotations')}}</a></li>
                    ...
                    <form id="quotation-form" action="{{ route('quotations.store') }}" method="POST">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="status" id="status" required>
                                        ...
                                        <option value="Sent">{{__('public.Sent')}}</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mt-3">
                            <button type="submit" class="btn btn-primary">
                                {{__('public.CreateQuotation')}} <i class="bi bi-check"></i>
                            </button>
                        </div>
                    </form>
                </div>
