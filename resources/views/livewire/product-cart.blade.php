            ...
            <table class="table table-bordered">
                <thead class="thead-dark">
                    <tr>
                        ...
                        <th class="align-middle text-center">{{__('public.NetUnitPrice')}}</th>
                        <th class="align-middle text-center">{{__('public.Stock')}}</th>
                        <th class="align-middle text-center">{{__('public.Quantity')}}</th>
                        <th class="align-middle text-center">{{__('public.Discount')}}</th>
                        <th class="align-middle text-center">{{__('public.Tax')}}</th>
                        <th class="align-middle text-center">{{__('public.SubTotal')}}</th>
                        <th class="align-middle text-center">{{__('public.Action')}}</th>
                    </tr>
                </thead>
                <tbody>
    ...
    <div class="form-row">
        <div class="col-lg-4">
            <div class="form-group">
                <label for="tax_percentage">{{__('public.Tax')}} (%)</label>
        ...
        <div class="col-lg-4">
            <div class="form-group">
                <label for="shipping_amount">{{__('public.Shipping')}}</label>
