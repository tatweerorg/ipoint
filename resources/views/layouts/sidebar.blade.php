<div class="c-sidebar c-sidebar-dark c-sidebar-fixed c-sidebar-lg-show {{ request()->routeIs('app.pos.*') ? 'c-sidebar-minimized' : '' }}" id="sidebar">
    <div class="c-sidebar-brand d-md-down-none bg-white">
        <a href="{{ route('home') }}">
            <img class="c-sidebar-brand-full" src="{{ asset('images/ipointlogo.png') }}" alt="Site Logo" width="110">
            <img class="c-sidebar-brand-minimized" src="{{ asset('images/ipoint.png') }}" alt="Site Logo" width="40">
        </a>
    </div>
