    ...
    <div class="container">
        <div class="row mb-3">
            <div class="col-12 d-flex justify-content-center">
                <img width="200" src="{{ asset('images/ipointlogo.png') }}" alt="Logo">
            </div>
        </div>
        <div class="row justify-content-center">
            <div class="col-md-5">
                ...
                <div class="card p-4 border-0 shadow-sm">
                    <div class="card-body">
                        <form id="login" method="post" action="{{ url('/login') }}">
                            @csrf
                            <h1>{{__('public.Login')}}</h1>
                            <p class="text-muted">{{__('public.SignIntoyouraccount')}}</p>
                ...
                <p class="text-center mt-5 lead">
                    {{__('public.Developed')}} 
                    <a href="" class="font-weight-bold text-primary">ZAID TURMAN</a>
                </p>
            </div>
        </div>
    </div>
